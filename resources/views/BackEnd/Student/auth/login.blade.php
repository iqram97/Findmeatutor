...
<head>
    ...
    <title>Find A Tutor (Students/Parents) - Login</title>
    <!-- Bootstrap Core CSS -->
...
<section id="wrapper" class="new-login-register">
    ...
    <div class="new-login-box">
        <div class="white-box">
            <h3 class="box-title m-b-0">Sign In to Students/Parents</h3>
            <small>Enter your details below</small>
            <form method="post" action="{{route('student.login')}}" class="form-horizontal new-lg-form" id="loginform">
                @csrf
                <div class="form-group  m-t-20">
                    <div class="col-xs-12">
                        <label>Students/Parents Email Address</label>
                        <input class="form-control" type="text" required="" placeholder="Students/Parents Email" name="email">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <label>Students/Parents Password</label>
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>Don't have an account? <a href="{{route('student.register')}}" class="text-primary m-l-5"><b>Sign Up</b></a></p>
                    </div>
                </div>
            </form>
