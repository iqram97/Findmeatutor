...
<head>
    ...
    <title>Find A Tutor (Students/Parents) - Register</title>
    <!-- Bootstrap Core CSS -->
...
<section id="wrapper" class="new-login-register">
    ...
    <div class="new-login-box">
        <div class="white-box">
            <h3 class="box-title m-b-0">Sign UP to Students/Parents</h3> <small>Enter your details below</small>
            <form class="form-horizontal new-lg-form" id="loginform" action="{{route('student.register')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>Already have an account? <a href="{{route('student.login')}}" class="text-danger m-l-5"><b>Sign In</b></a></p>
                    </div>
                </div>
            </form>
        </div>
