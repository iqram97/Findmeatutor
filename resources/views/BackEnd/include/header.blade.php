    ...
    <div class="navbar-header">
        <div class="top-left-part">
            ...
            <a class="logo" href="{{route('admin.home')}}">
                <b><img src="{{asset('/')}}backEnd/images/logo.png" alt="home" class="light-logo"/></b>
            </a>
        </div>
        <!-- /Logo -->
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    ...
                    <li>
                        <div class="message-center">
                            <a href="#">
                                <div class="user-img"><img src="{{asset('/')}}backEnd/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle"> <span
                                        class="profile-status online pull-right"></span></div>
                                <div class="mail-contnet">
                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span></div>
                            </a>
                            <a href="#">
                                <div class="user-img"><img src="{{asset('/')}}backEnd/plugins/images/users/sonu.jpg" alt="user" class="img-circle"> <span
                                        class="profile-status busy pull-right"></span></div>
                                <div class="mail-contnet">
                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span></div>
                            </a>
                            <a href="#">
                                <div class="user-img"><img src="{{asset('/')}}backEnd/plugins/images/users/arijit.jpg" alt="user" class="img-circle"> <span
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{{asset('/')}}backEnd/images/avatar.jpg" alt="user-img"
                                                                                             width="36"
                ...
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    <li>
                        <div class="dw-user-box">
                            <div class="u-img"><img src="{{asset('/')}}backEnd/images/avatar.jpg" alt="user"/></div>
                            <div class="u-text">
